...
export const CloseIcon: React.FC<SVGLogoProps> = ({width, height}) => {
  ...
  <path d="M56.25 33.75L33.75 56.25" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M33.75 33.75L56.25 56.25" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>`;
